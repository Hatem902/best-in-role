...
export default async function BestInRole() {
  return (
    <>
      ...
      <main className=" mobile:-mb-[11.3rem] mobile:-ml-[19.6rem] mobile:-mr-[4rem] mobile:-mt-[11.3rem]  mobile:scale-[.78] mx-0 mb-2 mt-4 flex w-full  max-w-fit scale-100  transform-gpu space-x-1.5 laptop_sm:-mb-[8.7rem] laptop_sm:-ml-[13.5rem] laptop_sm:-mr-[1.4rem] laptop_sm:-mt-[8.9rem] laptop_sm:scale-[.83] laptop:-mb-[3.2rem] laptop:-ml-20 laptop:-mt-[3.4rem] laptop:scale-[.93] desktop:mx-0 desktop:mb-2 desktop:mt-4   desktop:scale-100 ">
        {roles.map((role) => (
