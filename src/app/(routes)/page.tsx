...
export default async function BestInRole() {
  return (
    <>
      ...
      <main className="laptop_sm:-mb-[8.7rem] laptop_sm:-ml-[13.5rem] laptop_sm:-mr-[1.4rem] laptop_sm:-mt-[8.9rem] laptop_sm:scale-[.83] -mb-[11.3rem]  -ml-[19.6rem] -mr-[4rem]  -mt-[11.4rem] flex w-full max-w-fit scale-[.78] transform-gpu space-x-1.5 laptop:-mb-[3.2rem] laptop:-ml-20 laptop:-mt-[3.5rem] laptop:scale-[.93] desktop:mx-0 desktop:my-4 desktop:scale-100 ">
        {roles.map((role) => (
